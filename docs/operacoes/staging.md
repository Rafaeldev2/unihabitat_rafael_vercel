...
10. **`supabase-migration-ofertas-vendedor.sql`** — `ofertas.vendedor_id` + uniques parciales (oferta del agente sin comprador)
11. `supabase-dev-policies.sql` — **solo staging**
